...
function addElement(event_ident,timestamp, id) {
    var newDiv = document.createElement("div");
    var time = get_time(parseInt(timestamp));
    var newContent = document.createTextNode(event_ident + " " + time);
    ...
    var a = document.createAttribute("data-event_ident");
    a.value = event_ident;
    newDiv.setAttributeNode(a);
...
function load_all() {
    ...
    for (let i = 0; i < arr.length - 1; i++) {
        ...
        var timestamp = obj["STB_TSTAMP"]
        var event_ident = obj["EVENT_IDENT"]
        addElement(event_ident, timestamp, i)
    }
}
